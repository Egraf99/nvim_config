...
let s:bg_string      = '#f8ffea'   " cterm: 194 - Light green for strings
let s:bg_string_esc  = '#dbecb6'   " cterm: 193 - Darker green for escapes
let s:bg_comment     = '#fffbce'   " cterm: 229 - Yellow for comments
let s:bg_definition  = '#e7f6ff'   " cterm: 189 - Light blue for definitions
let s:bg_error       = '#ffe8e8'   " cterm: 224 - Light red for errors
...
call s:HL('DiagnosticError',  s:error,        s:bg_main,      '16',  '224')
call s:HL('DiagnosticWarn',   s:warn,         s:bg_main,      '16',  '229')
call s:HL('DiagnosticInfo',   s:info,         s:bg_main,      '16',  '189')
call s:HL('DiagnosticHint',   s:fg_grey_dark, '',             '243', '')
call s:HL('DiagnosticOk',     s:ok,           s:bg_main,      '16',  '194')
...
let s:default_prog_languages = 'bash,c,cpp,css,go,html,java,javascript,php,python,ruby,rust,sh,shell,typescript,sql'
...
execute 'hi NeoTreeFloatBorder guifg=' . s:fg_black . ' guibg=' . s:bg_main . ' ctermfg=243'

" ----------------------------------------------------------------------------
" SQL
" ---------------------------------------------------------------------------- 

execute 'hi @keyword.sql guifg=' . s:fg_grey_very_light 
execute 'hi @keyword.operator.sql guifg=' . s:fg_grey_very_light 
execute 'hi @keyword.conditional.sql guifg=' . s:fg_grey_very_light 
execute 'hi @punctuation.delimiter.sql guifg=' . s:fg_grey_very_light 
execute 'hi @variable.member.sql guifg=' . s:fg_black . ' guibg=' . s:bg_purple
execute 'hi @boolean.sql guifg=' . s:fg_black ' guibg=' . s:bg_main
execute 'hi @relation.sql guifg=' . s:fg_black ' guibg=' . s:bg_string
execute 'hi @operator.sql guifg=' . s:fg_black ' guibg=' . s:bg_main
